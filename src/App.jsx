...
const EsteemedLeadership = () => (
  ...
  >
    ...
    <div style={{
      ...
      {[
        { src: '/presbyter.jpg', name: 'Rev. C. Samuel Jebakumar', role: 'Presbyter In-Charge' },
        { src: '/pastoratesecretary.jpg', name: 'Mr. S. Albert Kingsbell ', role: 'Pastorate Secretary' },
        { src: '/pastoratetreasurer.jpg', name: 'Mr. P. Horsley Solomon', role: 'Pastorate Treasurer' }
      ].map((leader, i) => (
        <motion.div
          key={i}
          initial={{ opacity: 0, y: 30 }}
          ...
          <div className="footer-content">
            <div className="footer-section">
              ...
              <div className="contact-links">
                <a href={GMAIL_LINK} target="_blank" rel="noopener noreferrer" className="contact-link">
